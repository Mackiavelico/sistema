...
<body>
    <div class="container">
        ...
        <p>ESTAS EN PANEL DE ADMINISTRADOR</p>
        ...
        echo "<p>¿Qué desea realizar?</p>";

        // Propiedades y métodos existentes...
        echo "<ul>";
            echo "<li><a href='agregar.php'>Agregar</a></li>";
            echo "<li><a href='leer.php'>Leer</a></li>";
        ...
        <li>
            <ul><a href='/sistema/logout.php'><h6>Salir de todo</h6></a></ul>
            <ul><a href='/sistema/index.php'><h6>Volver al index</h6></a></ul>
        </li>
        <br>
    </div>
